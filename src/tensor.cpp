...
void createFaceObj(const vector<cv::Point3f> faceVec, std::string pathToOutputObjFile)
{

    // get the suffix
    std::ifstream infile("F:/Capstone/LocalREp/Facial-Tracking2/data/obj/suffix.txt");
    if (infile.fail()) {
